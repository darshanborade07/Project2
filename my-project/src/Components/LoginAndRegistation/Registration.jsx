...
<<<<<<< HEAD:my-project/src/Components/LoginAndRegistation/Registration.jsx
import React, {useState} from 'react';
=======
import React, { useState } from 'react';
>>>>>>> 15bb30a868f3b5dc75a121a6a5ae030358c02063:my-project/src/Components/LoginAndRegistation/Registation.jsx
          ...
          <div className='w-1/2 px-12'>
            ...
            <form onSubmit={handleSignup}>
                ...
                <div className='grid grid-cols-2 gap-5'>
                    <input type='text' placeholder='FirstName' className='border border-gray-400 py-1 px-2' value={firstName} onChange={(e) => setFirstName(e.target.value)} required></input>
                    <input type='text' placeholder='LastName' className='border border-gray-400 py-1 px-2'value={lastName} onChange={(e) => setLastName(e.target.value)} required></input>
                </div>
                
                <div className='mt-5'>
                    <input type='email' placeholder='Email' className='border border-gray-400 py-1 px-2 w-full'  value={email} onChange={(e) => setEmail(e.target.value)} required></input>
                </div>
                ...
                <div className='mt-5'>
                    <input type='text' placeholder='Address' className='border border-gray-400 py-1 px-2 w-full'value={address} onChange={(e) => setAddress(e.target.value)} required></input>
                </div>
