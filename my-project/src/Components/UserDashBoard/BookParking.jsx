...
const BookParking = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    parking_slot_id: slotId, // Set from URL params
...
=======
    const userId = user? JSON.parse(user).id : null; // Retrieve the user ID from the session storage
    console.log(userId);
>>>>>>> 15bb30a868f3b5dc75a121a6a5ae030358c02063
    if (userId) {
