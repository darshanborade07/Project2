...
function AddParkingArea(){
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8080/parkingAreas/Add', {
        area,
        city,
        pincode,
        latitude,
      ...
      console.error('There was an error adding the parking area!', error);
      alert('Failed to add parking area');
    }
  };
